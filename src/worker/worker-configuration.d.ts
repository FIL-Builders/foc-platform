/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker/worker-configuration.d.ts` (hash: 5287fa195a9b5396aa287144f9b4206e)
// Runtime types generated with workerd@1.20260630.1 2026-07-01 nodejs_compa
interface __BaseEnv_Env {
	FILECOIN_CALIBRATION_RPC_URL: "https://api.calibration.node.glif.io/rpc/v1";
	FOC_PLATFORM_DEMO_NETWORK: "filecoin_calibration";
	FOC_PLATFORM_DEMO_CHAIN_ID: "314159";
	FOC_PLATFORM_REGISTRY_ADDRESS: "0x7771d916a9d742B1D60597a332C7ABBd5796609c";
	FOC_PLATFORM_REGISTRY_DEPLOY_TX: "0xb6a4469ae4bff657326d25dd9989ebae54f03467c8ddee19001b1c114fe70552";
	FOC_PLATFORM_REGISTRY_DEPLOY_BLOCK: "3852147";
	FOC_PLATFORM_REGISTRY_RUNTIME_SHA256: "0xed478a27e255a1b27989ffa4f2fcbf38f1a9ec61a84c8d3e20aceb4e26f72040";
	FOC_PLATFORM_DEMO_GENERATED_AT: "2026-07-01T14:29:04.326Z";
	FOC_PLATFORM_DEMO_MODE: "calibration_live_evidence";
	FOC_PLATFORM_DEMO_STATUS: "Committed";
	FOC_PLATFORM_DEMO_OBJECT_ID: "1";
	FOC_PLATFORM_DEMO_ACCOUNT_ID: "0xfaa4a252e3d762275f3bb2baccba097024ed47a08845bee0de79a2ee58514e01";
	FOC_PLATFORM_DEMO_PROVIDER_ID: "4";
	FOC_PLATFORM_DEMO_DATASET_ID: "12524";
	FOC_PLATFORM_DEMO_PIECE_ID: "34";
	FOC_PLATFORM_DEMO_PIECE_CID: "bafkzcibeqcad6egqwuynxmfu6jof2lzkfdp65aelknasuautd4mmjgpvujkaq2ytey";
	FOC_PLATFORM_DEMO_RETRIEVAL_URL: "https://caliberation-pdp.infrafolio.com/piece/bafkzcibeqcad6egqwuynxmfu6jof2lzkfdp65aelknasuautd4mmjgpvujkaq2ytey";
	FOC_PLATFORM_DEMO_UPLOAD_TX_HASH: "";
	FOC_PLATFORM_DEMO_REGISTRY_TX_HASHES_JSON: "{\"setCoordinator\":\"0xcf21feda99029624d18bcf17035f0f5d0f9c7bc67680ca0d32f210d6acf370ce\",\"requestUpload\":\"0x552b1da9b049dc1301effcc34c497625a1e09934b25bec7e5a3fe607ba3382fd\",\"startUpload\":\"0x1d1104fb0807ff05f4a4c9045dcfc888a54bd6d143edab25e19ec6d4bd6a8bb1\",\"recordDataset\":\"0x3ec159924041a28531652a23ca4343f7aa8186da47f5c27cc6e8410bee5a3ea3\",\"finalizeUpload\":\"0xebbf1d335df22f3607e9552753360d80d48fd28d199ef0afa19f052d5fd57608\"}";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./calibration-demo");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FILECOIN_CALIBRATION_RPC_URL" | "FOC_PLATFORM_DEMO_NETWORK" | "FOC_PLATFORM_DEMO_CHAIN_ID" | "FOC_PLATFORM_REGISTRY_ADDRESS" | "FOC_PLATFORM_REGISTRY_DEPLOY_TX" | "FOC_PLATFORM_REGISTRY_DEPLOY_BLOCK" | "FOC_PLATFORM_REGISTRY_RUNTIME_SHA256" | "FOC_PLATFORM_DEMO_GENERATED_AT" | "FOC_PLATFORM_DEMO_MODE" | "FOC_PLATFORM_DEMO_STATUS" | "FOC_PLATFORM_DEMO_OBJECT_ID" | "FOC_PLATFORM_DEMO_ACCOUNT_ID" | "FOC_PLATFORM_DEMO_PROVIDER_ID" | "FOC_PLATFORM_DEMO_DATASET_ID" | "FOC_PLATFORM_DEMO_PIECE_ID" | "FOC_PLATFORM_DEMO_PIECE_CID" | "FOC_PLATFORM_DEMO_RETRIEVAL_URL" | "FOC_PLATFORM_DEMO_UPLOAD_TX_HASH" | "FOC_PLATFORM_DEMO_REGISTRY_TX_HASHES_JSON">> {}
}
...
interface WebSocketAcceptOptions {
    /**
     * When set to `true`, receiving a server-initiated WebSocket Close frame will no
 ...
 *
 * Used as the type of an `env.MEMORY`-style binding backed by the Agen
 * Memory product.
 *
 * @example
 * ```ts
...
interface Ai_Cf_Baai_Bge_M3_Input_QueryAnd_Contexts {
    ...
    contexts: {
        /**
         * One of the provided context conten
         */
        text?: string;
    }[];
    /**
...
interface Ai_Cf_Baai_Bge_M3_Output_Query {
    response?: {
        /**
         * Index of the context in the reques
         */
        id?: number;
        /**
...
type Ai_Cf_Meta_Llama_3_2_11B_Vision_Instruct_Output = {
    ...
    tool_calls?: {
        /**
         * The arguments passed to be passed to the tool call reques
         */
        arguments?: object;
        /**
...
type Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Output = {
    ...
    response: string;
    /**
     * Usage statistics for the inference reques
     */
    usage?: {
        /**
         * Total number of tokens in inpu
         */
        prompt_tokens?: number;
        /**
         * Total number of tokens in outpu
         */
        completion_tokens?: number;
        /**
...
interface Ai_Cf_Qwen_Qwen3_30B_A3B_Fp8_Chat_Completion_Response {
    ...
    choices?: {
        /**
         * Index of the choice in the lis
         */
        index?: number;
        /**
        ...
        message?: {
            ...
            /**
             * Tool calls made by the assistan
             */
            tool_calls?: {
                /**
...
interface Ai_Cf_Deepgram_Nova_3_Input {
    ...
    /**
     * Custom intents you want the model to detect within your input audio if presen
     */
...
interface Ai_Cf_Leonardo_Phoenix_1_0_Input {
    ...
    prompt: string;
    /**
     * Controls how closely the generated image should adhere to the prompt; higher values make the image more aligned with the promp
     */
    guidance?: number;
    /**
...
/**
 * The generated image in JPEG forma
 */
...
/**
 * The generated audio in MP3 forma
 */
...
interface Ai_Cf_Deepgram_Flux_Output {
    ...
    transcript?: string;
    /**
     * The words in the transcrip
     */
    words?: {
        /**
         * The individual punctuated, properly-cased word from the transcrip
         */
        word: string;
        /**
...
interface BrowserRunBaseOptions {
     ...
     * @see https://pptr.dev/api/puppeteer.viewpor
...
/**
 * In addition to the properties you can set in the RequestInit dic
...
interface RequestInitCfProperties extends Record<string, unknown> {
     ...
     *
     * Note - For security reasons, the hostname set in resolveOverride mus
     * be proxied on the same Cloudflare zone of the incoming request.
     * Otherwise, the setting is ignored. CNAME hosts are allowed, so to
     * resolve to a host under a different domain or a DNS only domain firs
...
interface RequestInitCfPropertiesVaryAcceptLanguageHeader extends RequestInitCfPropertiesVaryHeader {
    /**
     * Language tags to keep when normalizing the `Accept-Language` reques
     * header.
     */
    languages?: string[];
}
...
interface BasicImageTransformations {
    ...
    zoom?: number;
    /**
     * Resizing mode as a string. It affects interpretation of width and heigh
     * options:
     ...
     *  - squeeze: Stretches and deforms to the width and height given, even if i
     *    breaks aspect ratio
     */
     ...
     *
     * It can be used as:
     * - left, top, right, bottom - it will specify the number of pixels to cu
     *   off each side
    ...
    flip?: 'h' | 'v' | 'hv';
    /**
     * Number of degrees (90, 180, 270) to rotate the image by. width and heigh
     * options refer to axes after rotation.
     */
    rotate?: 0 | 90 | 180 | 270 | 360;
    /**
     * Strength of sharpening filter to apply to the image. Floating-poin
    ...
    saturation?: number;
    /**
     * Device Pixel Ratio. Default 1. Multiplier for width/height that makes i
    ...
    /**
     * Image segmentation using artificial intelligence models. Sets pixels no
...
interface RequestInitCfPropertiesImageDraw extends BasicImageTransformations {
    ...
    repeat?: true | "x" | "y";
    /**
     * How to combine the foreground and backdrop pixels to create the resul
     */
    composite?:
...
interface RequestInitCfPropertiesImage extends BasicImageTransformations {
     ...
     *  - webp: generate images in Google WebP format. Set quality to 100 to ge
...
interface IncomingRequestCfPropertiesCloudflareForSaaSEnterprise<HostMetadata> {
     ...
     *
     * This field is only present if you have Cloudflare for SaaS enabled on your accoun
...
interface IncomingRequestCfPropertiesGeographicInformation {
    ...
    city?: string;
    /**
     * Postal code of the incoming reques
     *
     * @example "78701"
     */
    postalCode?: string;
    /**
     * Latitude of the incoming reques
     *
     * @example "30.27130"
     */
    latitude?: string;
    /**
     * Longitude of the incoming reques
     *
     * @example "-97.74260"
     */
    longitude?: string;
    /**
     * Timezone of the incoming reques
     *
     ...
     * the IP address of the incoming reques
     *
     * @example "Texas"
     */
    region?: string;
    ...
    regionCode?: string;
    /**
     * Metro code (DMA) of the incoming reques
     *
     * @example "635"
     */
    metroCode?: string;
...
interface IncomingRequestCfPropertiesTLSClientAuth {
    ...
    /**
     * The certificate's SHA-1 fingerprin
     *
     * @example "6b9109f323999e52259cda7373ff0b4d26bd232e"
     */
    certFingerprintSHA1: string;
    /**
     * The certificate's SHA-256 fingerprin
     *
 ...
 * @example
 * ```typescrip
 * // Get a boolean flag value with a defaul
...
interface ImageTransformer {
     ...
     * provided inpu
     * @param options Options that apply to the output e.g. output forma
     */
...
interface MediaTransformer {
     ...
     * @returns A generator for producing the transformed media outpu
     */
...
declare module "cloudflare:pipelines" {
    export abstract class PipelineTransformationEntrypoint<Env = unknown, I extends PipelineRecord = PipelineRecord, O extends PipelineRecord = PipelineRecord> {
         ...
         * @param metadata Information about the specific pipeline calling the transformation entrypoin
...
declare namespace Cloudflare {
    // Type of `env`.
    //
    // The specific project can extend `Env` by redeclaring it in project-specific files. Typescrip
    ...
    //
    // This interface is, again, intended to be declared in project-specific files, and then tha
    ...
    // Evaluates to the type of a property in GlobalProps, defaulting to `Default` if it is no
    // present.
...
interface SecretsStoreSecret {
     ...
     * if it exists, or throws an error if it does not exis
     */
    get(): Promise<string>;
}
...
type StreamUrlUploadParams = {
    ...
    requireSignedURLs?: boolean;
    /**
     * Indicates the date and time at which the video will be deleted. Omi
...
/**
 * An object with download type keys. Each key is optional and only present if tha
